...
<div class="topnav">
  ...
  <a class="active"  href="dept.php">Department</a>
  <a href="contact.php">Contact</a>
    <a href="faculties.php">Faculties</a>
  <a href="stdcor.php">Student corner</a>
  <a href="about.php">About us</a>
</div>
<h3 style="padding-left:16px;text-align:center;">Faculty of Electrical, Electronic and Communication Engineering<h3>
